...
def create_data(num_employees: int = 100):
    ...
    # Empleados Data
    employees_data = {
        "employee_id": np.random.randint(1000, 9999, num_employees),
        ...
        "hire_date": [datetime(2021, np.random.randint(1, 13), np.random.randint(1, 29)) for _ in range(num_employees)],
    }
